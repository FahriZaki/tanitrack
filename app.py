...
# Fungsi cek dominasi warna hijau
def dominan_hijau(image_file):
...
# Halaman PREDIKSI PENYAKIT
    ...
    if uploaded_file is not None:
        ...
        with st.spinner("🔎 Mengecek validitas gambar..."):
            uploaded_file.seek(0)  # reset pointer sebelum dibaca
            if not dominan_hijau(uploaded_file):
                ...
                uploaded_file.seek(0)  # reset lagi sebelum dipakai di model
